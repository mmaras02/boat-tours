...
export const LocationMap = () => {
  const openInGoogleMaps = () => {
    window.open(
      'https://www.google.com/maps/search/?api=1&query=43.4998,16.4577',
      '_blank',
    );
  };

  return (
    <div className="relative h-125 bg-white rounded-lg shadow-xl overflow-hidden border-2 border-gray-200">
      <iframe
        title="Uvala Zenta (lučica), Split Location"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2888.5!2d16.4557!3d43.4998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13355e5e5e5e5e5e%3A0x5e5e5e5e5e5e5e5e!2sUvala%20Zenta!5e0!3m2!1sen!2shr!4v1709991234567!5m2!1sen!2shr"
      ...
      <div className="absolute bottom-0 left-1/2 z-10 -translate-x-1/2 bg-linear-to-t from-black/60 to-transparent p-4 text-center">
        <div className="text-white">
          ...
          <p className="text-sm text-white/80">
            Ul. Uvala Zenta, 21000, Split, Croatia
          </p>
        </div>
      </div>
    </div>
