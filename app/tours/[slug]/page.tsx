...
import { CalendarDays, Users, Ship, CheckCircle, XCircle, Shield } from "lucide-react";
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <div className="flex flex-wrap gap-20 text-sm text-slate-600 border-b border-slate-300 pb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-s uppercase tracking-wider text-slate-500">Duration</p>
                                    <p className="font-semibold text-[#17384A]">{tour.duration}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-s uppercase tracking-wider text-slate-500">Group Size</p>
                                    <p className="font-semibold text-[#17384A]">Up to {tour.max_guests}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-s uppercase tracking-wider text-slate-500">Boat</p>
                                    <p className="font-semibold text-[#17384A]">{tour.boat_type}</p>
                                </div>
                            </div>
