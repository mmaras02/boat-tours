        ...
        <div className="sticky top-24 space-y-6">
            ...
            <div className="relative bg-white/95 backdrop-blur-md border border-slate-300 shadow-[0_20px_70px_-15px_rgba(23,56,74,0.3)] overflow-hidden group">
                ...
                <div className="relative p-8 text-center border-b border-slate-100">
                    ...
                    <p className="text-sm uppercase tracking-[0.3em] text-slate-500 mb-3">Starting Price</p>
                    <div className="flex items-center justify-center gap-1">
                        <span className="text-5xl font-bold text-[#17384A]">{tour.price}</span>
                    </div>
                    <p className="text-sm text-slate-600 mt-3 font-medium">Private tour for your group</p>
            ...
            <div className="flex flex-wrap justify-center gap-3 text-xs text-slate-500">
                <span className="px-3 py-1.5 bg-white/80 backdrop-blur-sm rounded-full border border-white/40">✓ Secure Booking</span>
                <span className="px-3 py-1.5 bg-white/80 backdrop-blur-sm rounded-full border border-white/40">✓ Best Price</span>
                <span className="px-3 py-1.5 bg-white/80 backdrop-blur-sm rounded-full border border-white/40">✓ Local Experts</span>
            </div>
        </div>
