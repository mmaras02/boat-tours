...
export function Footer() {
  ...
  return (
    <footer>
      <div className="bottom-0 max-w-full mx-auto px-6 py-12 flex flex-col md:flex-row justify-evenly gap-8 bg-navbar text-gray-300">
        <div>
      ...
      <div className="border-t border-white/10 py-4 text-center text-sm bg-navbar text-gray-300">
