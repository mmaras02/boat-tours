...
export const ReasonsSection = () => {
  return (
    <section className="pb-5 pt-10 bg-slate-50 mt-2 overflow-visible">
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-stretch">
          {tourBenefits.map((benefit, i) => (
            <article
              key={i}
              className="relative border border-slate-200 bg-white px-6 pt-14 pb-8 text-center min-h-75 flex flex-col"
            >
